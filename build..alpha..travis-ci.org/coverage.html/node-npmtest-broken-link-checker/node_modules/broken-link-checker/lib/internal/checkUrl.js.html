...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-broken-link-checker/node_modules/broken-link-checker/lib/internal/checkUrl.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-broken-link-checker/node_modules/broken-link-checker/lib/internal/checkUrl.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-broken-link-checker/node_modules/broken-link-checker/lib/internal/</a> &#187; checkUrl.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >	if (retry === undefined)</span>
	{
...
<span class="cstat-no" title="statement not covered" >		cached = cache.get(link.url.parsed);</span>
		
<span class="cstat-no" title="statement not covered" >		if (cached !== undefined)</span>
		{
<span class="cstat-no" title="statement not covered" >			return Promise.resolve(cached).then( <span class="fstat-no" title="function not covered" >function(response)</span></span>
			{
				// Cloned to avoid unexpected mutations as a result of user changes
<span class="cstat-no" title="statement not covered" >				response = extend({}, response);</span>
				
<span class="cstat-no" title="statement not covered" >				copyResponseData(response, link, options);</span>
				
<span class="cstat-no" title="statement not covered" >				link.http.cached = true;</span>
...
<span class="cstat-no" title="statement not covered" >		if (options.cacheResponses===true &amp;&amp; response.url!==link.url.resolved)</span>
		{
...
<span class="cstat-no" title="statement not covered" >		if (options.cacheResponses === true)</span>
		{
<span class="cstat-no" title="statement not covered" >			cache.set(link.url.parsed, request);</span>
		}
